...
- **Follow this repo's actual conventions.** Reference CLAUDE.md and the real file layout (frontend/backend split, Prisma import rules, design-token discipline, etc.) rather than generic best practices, whenever those conventions are relevant to the plan.
