        ...
        <div className="grid grid-cols-2 gap-8">
            ...
            <div className="_border p-6 pt-[21px] rounded-2xl flex flex-col">
                ...
                <div className="flex items-center gap-2 relative ">
                    <input ref={knownRef} onChange={(e) => { setKnownInput(e.target.value); if (e.target.value.length > 2) availableMutation.mutate({ data: e.target.value }) }} placeholder="Add a skill you know..." type="text" className="input basis-full" />
                    <button onClick={() => {
            ...
            <div className="_border p-6 pt-[21px] rounded-2xl flex flex-col">
                ...
                <div className="flex items-center gap-2 relative">
                    <input ref={learnRef} onChange={(e) => { setWantToLearnInput(e.target.value); if (e.target.value.length > 2) availableMutation.mutate({ data: e.target.value }) }} placeholder="Add a skill you want to learn..." type="text" className="input basis-full" />
                    <button onClick={() => {
