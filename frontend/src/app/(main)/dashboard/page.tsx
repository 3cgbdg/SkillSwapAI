    ...
    return (
        <div className="flex flex-col gap-[33px]">
            ...
            <div className="flex flex-col gap-6">
                ...
                {sessions && (sessions.length > 0 ? sessions.filter(s => {
                    ...
                    <div className="_border rounded-xl overflow-hidden flex flex-col">
                        <div className="not-last:border-b-[1px] border-neutral-300 flex justify-between items-center p-4 pt-5">
                            <div className="">
                                ...
                                <p className="text-sm leading-5 text-gray">{item.start}:00 - {item.end}:00</p>
                            </div>
                            <button className="mr-4 link">View Details</button>
                        </div>
                    </div>
                )) : <div className="not-last:border-b-[1px] _border flex justify-between items-center p-4 pt-5 rounded-md mx-auto px-10">No upcoming sessions</div>)}
